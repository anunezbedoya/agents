...
class ADKClient:
    ...
    def diagnose_ticket(self, ticket_text: str) -> str:
        try:
            contexto = """
Eres un ingiero de soporte de nivel 1  dedicado a diagnosticar y clasificar correctamente el ticket recibido, aplicando criterios técnicos y operativos. Tu tarea es entender la naturaleza del caso, validar su información, definir la acción inicial y, si es necesario, escalar correctamente.
...
Estructura la respuesta en este formato:

plaintext

CopyEdit

1. Tipo de ticket: [Incidente | Petición | Requerimiento]  

2. Diagnóstico: [resumen técnico del análisis realizado]  

3. Estado de resolución: [Resuelto desde aplicación | Requiere escalamiento]  

4. Acción sugerida: [Escalar a Segundo Nivel | Escalar a Ingeniería | Cerrar caso]  

5. Observaciones: [campos faltantes, inconsistencias o notas adicionales]
